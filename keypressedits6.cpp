...
int main(){
    string loopCase, keyNum, keyStrHoldTime;
    string keyCurrentInput[100] = {};
    int times, keyHoldTime;
    bool infinite = false;
    ...
    cout << "How many seconds should every key be held?" << endl;
    cin >> keyStrHoldTime;
    keyHoldTime = stod(keyStrHoldTime);
